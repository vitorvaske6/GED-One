...
{"contratos" : [
    <#list contratos as child>
        ...
        <#if child.contrato.properties["printerOneContratos:equipamentosContratoWS"]?exists && child.contrato.properties["printerOneContratos:equipamentosContratoWS"] != "">
        {
            ...
            "Inscrição Estadual" : "<#if child.contrato.properties["printerOneContratos:inscricaoEstadual"]?exists && child.contrato.properties["printerOneContratos:inscricaoEstadual"] !="">${child.contrato.properties["printerOneContratos:inscricaoEstadual"]}</#if>",
