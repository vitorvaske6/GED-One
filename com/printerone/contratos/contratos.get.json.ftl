...
{"contratos" : [
    <#list contratos as child>
        <#if child.contrato.properties["printerOneContratos:equipamentosContratoWS"]?exists && child.contrato.properties["printerOneContratos:equipamentosContratoWS"] != "">
        {
            ...
            "Inscricao Estadual" : "<#if child.contrato.properties["printerOneContratos:inscricaoEstadual"]?exists && child.contrato.properties["printerOneContratos:inscricaoEstadual"] !="">${child.contrato.properties["printerOneContratos:inscricaoEstadual"]}</#if>",
            ...
            "Valor do Aluguel Mensal" : "<#if child.contrato.properties["printerOneContratos:valorAluguelMensal"]?exists && child.contrato.properties["printerOneContratos:valorAluguelMensal"] != 0>${child.contrato.properties["printerOneContratos:valorAluguelMensal"]?replace(',','')?replace('.',',')}<#else>0</#if>",
            "Valor do Aluguel Total" : "<#if child.contrato.properties["printerOneContratos:valorAluguel"]?exists && child.contrato.properties["printerOneContratos:valorAluguel"] != 0>${child.contrato.properties["printerOneContratos:valorAluguel"]?replace(',','')?replace('.',',')}<#else>0</#if>",
